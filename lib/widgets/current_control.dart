/// Current control widget with slider and text input.

import 'package:flutter/material.dart';

class CurrentControl extends StatefulWidget {
  final double value;
  final double min;
  final double max;
  ...
  @override
  State<CurrentControl> createState() => _CurrentControlState();
}

class _CurrentControlState extends State<CurrentControl> {
  ...
  @override
  void didUpdateWidget(CurrentControl oldWidget) {
